...
export default function Writing() {
  ...
  return (
    <div className="min-h-screen relative">
      ...
      <Section id="bnpl-article" className="relative">
        {/* Timeline Dot */}
          ...
          <article className="card p-8 lg:p-12">
            <div className="space-y-6">
              ...
              <div className="prose prose-lg max-w-none text-secondary-700 dark:text-secondary-300 leading-relaxed">
                <p>
                  The Buy Now, Pay Later (BNPL) industry, once dismissed as a post-pandemic bubble, is showing unmistakable signs of renewed strength. From consumer spending resilience to retail and payment giants beating forecasts, <strong>all macro signals are aligning for a bullish earnings season</strong>. With <strong>Klarna (KLAR)</strong> and <strong>Sezzle (SEZL)</strong> both approaching November 2025 reports — and historical proof that they outperform in precisely these conditions — the setup looks primed for a breakout.
                </p>
              </div>
              ...
              <details className="group">
                ...
                <div className="mt-6 prose prose-lg max-w-none text-secondary-700 dark:text-secondary-300 leading-relaxed space-y-6">
                  ...
                  <p>
                    The U.S. consumer continues to defy expectations. Data from the Commerce Department (October 2025) shows retail sales up <strong>3.5% YoY</strong> in Q3 2025, with October marking one of the strongest pre-holiday months since 2019.
                  </p>
                  ...
                  <ul className="list-disc list-inside space-y-2 ml-4">
                    <li><strong>Costco (COST):</strong> +5.7% comps; +26% digital comps</li>
                    <li><strong>Walmart (WMT):</strong> +4.6% U.S. comps ex-fuel</li>
                    <li><strong>Amazon (AMZN):</strong> +13% YoY net sales in Q3 2025</li>
                  </ul>

                  <p>
                    Paired with <strong>PayPal's BNPL surge (+20% YoY TPV in Q3 2025)</strong> and Visa's +9% payment growth, the entire consumer finance ecosystem is expanding.
                  </p>
                  ...
                  <ul className="list-disc list-inside space-y-2 ml-4">
                    <li><strong>BNPL TPV:</strong> +20% YoY → ~$40B annualized</li>
                    <li><strong>Total Payment Volume:</strong> $458B (+8%)</li>
                    <li><strong>Revenue:</strong> $8.4B (+7%)</li>
                    <li><strong>EPS Guidance:</strong> Raised to $5.35–$5.39 for FY2025</li>
                  </ul>
                  ...
                  <p>
                    Sezzle's six-quarter streak of revenue and income beats has made it one of the most reliable fintech performers. Its <strong>Q2 2025 selloff — despite record metrics — created an unusually bullish reset.</strong>
                  </p>

                  <p><strong>Valuation context (as of Oct. 31, 2025):</strong></p>
                  <ul className="list-disc list-inside space-y-2 ml-4">
                    <li><strong>P/E:</strong> 21× vs. 58× at its 2025 peak</li>
                    <li><strong>P/S:</strong> 6× vs. 14.8× peak</li>
                  </ul>

                  <p>
                    If Sezzle sustains 60–70% revenue growth, a re-rating toward 8–10× sales implies <strong>40–70% upside</strong>.
                  </p>
                  ...
                  <ul className="list-disc list-inside space-y-2 ml-4">
                    <li><strong>FY24 Revenue:</strong> $2.81B (+24% YoY)</li>
                    <li><strong>Net Income:</strong> +$21M (first profit since 2020)</li>
                    <li><strong>Q2 2025 Revenue:</strong> $823M (+21%)</li>
                    <li><strong>Net Cash:</strong> $5.9B</li>
                  </ul>

                  <p>
                    At ~$37.6/share, Klarna's <strong>EV/S multiple near 3×</strong> — half of Affirm's 6×. An EV/S expansion from 3× → 6× would justify <strong>$50–60/share</strong>.
                  </p>
                  ...
                  <p>Recent 13F disclosures reveal <strong>renewed hedge fund accumulation</strong> in both Klarna and Sezzle:</p>

                  <h4 className="text-lg font-semibold text-primary-700 dark:text-primary-300 mt-6 mb-3">Klarna (KLAR)</h4>
                  <ul className="list-disc list-inside space-y-2 ml-4">
                    <li><strong>ARK Invest</strong> initiated positions post-IPO</li>
                    <li><strong>Millennium & Citadel</strong> hold ~$120M in IPO allocations</li>
                    <li><strong>Viking Global</strong> position estimated at 1.5% of float</li>
                  </ul>

                  <h4 className="text-lg font-semibold text-primary-700 dark:text-primary-300 mt-6 mb-3">Sezzle (SEZL)</h4>
                  <ul className="list-disc list-inside space-y-2 ml-4">
                    <li><strong>Point72</strong> boosted holdings ~40% QoQ</li>
                    <li><strong>Renaissance Technologies</strong> re-entered Sept. 2025</li>
                  ...
                  <ul className="list-disc list-inside space-y-2 ml-4">
                    <li><strong>Affirm:</strong> EV/S ~6×, unprofitable</li>
                    <li><strong>Klarna:</strong> EV/S ~3×, profitable, cash-rich</li>
                    <li><strong>Sezzle:</strong> EV/S ~6×, profitable, expanding margins</li>
                  </ul>
                  ...
                  <ol className="list-decimal list-inside space-y-2 ml-4">
                    <li><strong>Pre-tariff holiday spending:</strong> Early demand could lift Q4 BNPL volumes by 10–15%</li>
                    <li><strong>Credit quality:</strong> Flat or declining delinquency rates will confirm BNPL resilience</li>
                    <li><strong>Revenue growth:</strong> Sezzle targeting &gt;$100M; Klarna expected ~$850M</li>
                    <li><strong>Margin retention:</strong> Sustaining &gt;35% operating margins confirms scalability</li>
                    <li><strong>Profit streak:</strong> Klarna's third consecutive profitable quarter post-IPO</li>
                  </ol>
                  ...
                  <ul className="list-disc list-inside space-y-2 ml-4">
                    <li><strong>Credit provisions:</strong> Rising consumer leverage could pressure EPS</li>
                    <li><strong>Regulatory tightening:</strong> CFPB and EU oversight may raise compliance costs</li>
                    <li><strong>Lock-up expirations:</strong> Klarna's post-IPO float (expiring Jan. 2026) could increase volatility</li>
                    <li><strong>Guidance management:</strong> Market punishes small misses or soft guidance</li>
                  </ul>
                  ...
                  <p>
                    <strong>Sezzle</strong> enters Q3 earnings with expectations flushed, operational momentum intact, and macro tailwinds behind it. <strong>Klarna</strong> approaches its first full quarter as a public company with cash reserves, profitability, and sector demand all leaning in its favor.
                  </p>

                  <p>
                    If both firms deliver on historical growth trends, the probability of a <strong>30–60% re-rating by year-end 2025</strong> is high — not as hype, but as a return to fair value in a sector that's quietly rebuilt itself on profit and scale.
                  </p>

                  {/* Disclaimer */}
                  <div className="mt-8 pt-6 border-t border-gray-200 dark:border-gray-700">
                    <h4 className="text-lg font-semibold text-primary-700 dark:text-primary-300 mb-3">Positions & Outlook</h4>
      ...
      <Section id="jpmorgan-article" className="mt-8 relative">
